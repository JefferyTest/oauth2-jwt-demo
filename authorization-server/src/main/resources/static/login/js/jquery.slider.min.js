(function(t, i, s, e) {
    var l = function(i, s) {
        this.ele = i;
        this.defaults = { width: $(this.ele).width(), height: 34, sliderBg: "#e8e8e8", color: "#666", fontSize: 12, bgColor: "#7ac23c", textMsg: "请按住滑块，拖动到最右边", successMsg: "验证成功", successColor: "#fff", time: 160, callback: function(t) {} };
    ...
    l.prototype = {
        ...
        sliderMousemove: function(i, e) {
            ...
            t(s).on("mousemove.slider", function(t) {
                ...
                if (l.sliderBtn_left < 0) { return }
                if (l.sliderBtn_left > l.maxLeft) { l.sliderBtn_left = l.maxLeft }
        ...
        sliderMouseup: function() {
            ...
            t(s).on("mouseup.slider", function() {
                if (i.sliderBtn_left != i.maxLeft) { i.sliderBtn_left = 0 } else {
                ...
                if (i.opts.callback && typeof i.opts.callback === "function") { i.opts.callback(i.result) }
            })
        }
    };
